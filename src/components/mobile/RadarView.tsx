...
export const RadarView: React.FC<RadarViewProps> = ({
  ...
  // Simulate walking movement (shifts coordinates by ~80m)
  const handleSimulateWalk = () => {
    ...
    triggerNotification('🚶‍♂️ Симуляція прогулянки: координати оновлено на +85м');
  };
      ...
      <div className="px-4 py-2.5 border-b border-neutral-900 bg-neutral-950/90 backdrop-blur-md sticky top-0 z-20">
        ...
        <div className="mt-2 pt-2 border-t border-neutral-900 flex items-center justify-between text-[11px] gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 rounded-md bg-neutral-900 hover:bg-neutral-850 text-neutral-300 border border-neutral-800 font-medium transition"
            title="Зсунути поточні координати на 80 метрів"
          >
            <Footprints className="w-3 h-3 text-emerald-400" />
            <span>Крок пішки</span>
          </button>
      ...
      <div className="p-3 flex flex-col items-center justify-center relative">
        ...
        <div className="mt-2 text-center">
          <p className="text-[11px] font-medium text-neutral-300">
            Знайдено <span className="text-amber-400 font-bold">{buddiesInRadius.length}</span> собутильників у радіусі {radarRadiusKm} км
          </p>
